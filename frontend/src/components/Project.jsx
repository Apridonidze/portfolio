const Project = ( { project , key ,id } ) => {
    return(
        <div className="project col-12 col-lg-5 d-flex flex-column border border-secondary rounded-2 p-2 " key={id} style={{cursor : "pointer"}} >
...
export default Project;//exporting component