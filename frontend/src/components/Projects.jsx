...
import driverTicketsImg from '../assets/projectimg/pr3.png';//importing project's image

import Project from './Project'; //importing component
...
const Projects = () => {
    ...
    ]; //array to easily map projects in project component

    return(
        <section id='projects'>
            <div className="projects-container container mt-3  rounded-1 p-2 mx-0">
